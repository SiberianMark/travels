    ...
    <div class="page-container" style="margin-top: 1em;">
        <table class="table table-border table-bordered table-hover" >
            ...
            <tr>
                ...
                <td><input type="text" class="input-text" onkeyup="this.value=this.value.replace(/\s/,'');" name="name" value="<?php echo ($list["name"]); ?>" placeholder="广告名称" required/></td>
            </tr>
            </thead>
            <tbody>
            <tr>
                <th class="text-r">广告描述：</th>
                <td><input type="text" class="input-text" onkeyup="this.value=this.value.replace(/\s/,'');" name="detail" value="<?php echo ($list["detail"]); ?>" placeholder="广告描述" required/></td>
            </tr>
            <tr>
                ...
                <td>
                    ...
                    <div id="image"><img src="<?php echo ($list["image"]); ?>" id="img" style="width: 150px;height:50px;float: left;" alt="无图"></div>&nbsp;&nbsp;
            ...
            <tr>
                ...
                <td><input type="text" class="input-text" id="num" name="url" value="<?php echo ($list["url"]); ?>" required/></td>
            </tr>
            <tr>
                <th class="text-r">排序：</th>
                <td><input type="text" class="input-text" name="sort" value="<?php echo ($list["sort"]); ?>"/></td>
            </tr>
            <tr class="text-c">
                <td colspan="2">
