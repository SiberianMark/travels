...
<form action="/index.php/Admin/TravelInfo/operateTravelInfo" method="post">
	<div class="page-container" style="width: 900px;margin:20px auto;">
		备注：1、标<span style="color:red;">*</span>为必填项；&nbsp;&nbsp;2、如果是包团，出游人数里只填写领队数量就可以。出游总人数和公司名字填写到出游备注里。
        <table class="table table-border table-bordered table-hover mt-10 table1">
            <tr>
				...
				<td><input id="visitorNum" class="input-text" type="text" name="visitorNum"/></td>
			</tr>
			<tr>
			...
			<tr>
				...
				<td><input class="input-text" type="text" name="deposit" value="<?php echo ($travelInfo["deposit"]); ?>"/></td>
	...
	<table id="addVisitors" class="table table-border table-bordered table-hover" style="margin:10px auto 0;">
...
<script type="text/javascript">
	...
	$("#add").click(function(){
		...
		if (lineType == 4) { //港澳台
			...
			if (count == 0) {
				content += '<tr><th style="text-align: center;"><span style="color:red;">*&nbsp;</span>真实名字</th>' +
