...
<div class="mt-20 ml-40" >
    <ul class="bar ml-20">
        ...
        <li class="bar_list current"><a class="bar_link" href="/Admin/Line/notice/id/<?php echo ($lineid); ?>">预订须知</a></li>
    ...
    <div class="mt-20 mb-40 ml-20">
        ...
        <form action="/Admin/Line/notice?ac=edit" method="post">
            ...
            <table class="table table-border table-bordered table-hover" style="width: 56em">
                <tr>
                    <th class="text-r">预订须知：</th>
                    <td>
                        <script type="text/plain" id="editor_id" name="notice" style="width:50em;height:21.875em;">
                            <?php echo ($notice); ?>
                        </script>
                    </td>
                </tr>
