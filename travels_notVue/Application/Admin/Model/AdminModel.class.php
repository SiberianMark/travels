...
{
	public $trueTableName = 'mmm_employee';

	public $fields = array('id', 'name', 'phone', 'password', 'department', 'qq', 'weixin', 'email', 'sex', 'nativeplace', 'address', 'entrytime', 'status', 'addtime', 'note', 'is_del', 'loginip', 'lastlogintime', '_pk' => 'id', );
